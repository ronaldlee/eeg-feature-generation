...
init_df = pd.read_csv('csv/out_dreamer_all.csv',  sep=',')
...
def train_model(x_train, y_train,x_test,y_test, save_to, epoch = 2):
    ...
    with strategy.scope():
        ...
        mc = ModelCheckpoint(save_to + '_best_model_dreamer.h5', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
    ...
    saved_model = load_model(save_to + '_best_model_dreamer.h5')
