...
#normalize x_train, x_test to be between 0 and 1
...
def train_model(x_train, y_train,x_test,y_test, save_to, epoch = 2):
    ...
    with strategy.scope():
        ...
        mc = ModelCheckpoint(save_to + '_best_model_lstm_normed.h5', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
    ...
    saved_model = load_model(save_to + '_best_model_lstm_normed.h5')
